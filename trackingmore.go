...
func main(){
    ...
    //var url string ="http://api.trackingmore.com/v2/trackings/miuson-international/RP325552475CN/en"
    //var postData string =""
    //httpDo(url,postData,"GET")
    ...
    //var url string ="http://api.trackingmore.com/v2/trackings/miuson-international/RP325552475CN"
    ...
    //var postData string = "{\"tracking_number\": \"RP325552475CN\",\"carrier_code\":\"miuson-international\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
    //httpDo(url,postData,"POST")

    //10 Modify courier code
    //var url string ="http://api.trackingmore.com/v2/trackings/update"
    //var postData string = "{\"tracking_number\": \"RP325552475CN\",\"carrier_code\":\"miuson-international\",\"update_carrier_code\":\"china-ems\"}"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"tracking_number\":\"RP325552475CN\",\"carrier_code\":\"miuson-international\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"carrier_code\":\"miuson-international\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
    //httpDo(url,postData,"POST")
